...
materialize! {
    ...
    pub struct QualifiedPathInExpression<Ty>{
        ...
        path <- Rep<P<(PathSep, PathExprSegment<Ty>)>>;
    }
}
#[cfg(feature = "printing")]
to_tokens! {
...
materialize! {
    ...
    pub struct QualifiedPathInType<Ty>{
        qualifier <- QualifiedPathType<Ty>;
        path <- Rep<P<(PathSep, TypePathSegment<Ty>)>>;
    }
}
#[cfg(feature = "printing")]
to_tokens! {
...
mod type_tests {
    ...
    insta_match_test!(parse print : it_matches_hello, TypePath<Ident>: hello);
    insta_match_test!(parse print : it_matches_tri_path, TypePath<Ident>: hello::world::hi);
    insta_match_test!(parse print : it_matches_bi_path, TypePath<Ident>: hello::world);
    insta_match_test!(parse print : it_matches_long_generic, TypePath<Ident>: hello::<Hi>);
    insta_match_test!(parse print : it_matches_short_generic, TypePath<Ident>: hello<Hi>);
    insta_match_test!(parse print : it_matches_fun, TypePath<P<Infallible>>: Fn());
    insta_match_test!(parse print : it_matches_fun_ret, TypePath<Paren<P<()>>>: Fn() -> ());
...
mod qualified_tests {
    ...
    insta_match_test!(parse print : it_matches_simple_paths, QualifiedPathInType<Ident> : <hello as Default>::Default);
}
...
mod generic_tests {
    ...
    insta_match_test!(parse print : it_matches_empty_generic_args, GenericArgs<P<Infallible>>: <>);
    insta_match_test!(parse print : it_matches_lifetime_args, GenericArgs<P<Infallible>>: <'a>);
    insta_match_test!(parse print : it_matches_typed_args, GenericArgs<Ident>: <T>);
    insta_match_test!(parse print : it_matches_pathed_args, GenericArgs<TypePath<P<Infallible>>>: <hello::world>);
    insta_match_test!(parse print : it_matches_multi_args, GenericArgs<TypePath<P<Infallible>>>: <'a, T, hello::world>);
}
