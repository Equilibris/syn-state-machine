...
pub type And = FPunct<'&'>;
pub type Or = FPunct<'|'>;
pub type AndAnd = P<(FJointPunct<'&'>, FPunct<'&'>)>;
pub type OrOr = P<(FJointPunct<'|'>, FPunct<'|'>)>;
pub type Shl = P<(FJointPunct<'<'>, FPunct<'<'>)>;
pub type Shr = P<(FJointPunct<'>'>, FPunct<'>'>)>;
pub type PlusEq = P<(FJointPunct<'+'>, FPunct<'='>)>;
pub type MinusEq = P<(FJointPunct<'-'>, FPunct<'='>)>;
pub type StarEq = P<(FJointPunct<'*'>, FPunct<'='>)>;
pub type SlashEq = P<(FJointPunct<'/'>, FPunct<'='>)>;
pub type PercentEq = P<(FJointPunct<'%'>, FPunct<'='>)>;
pub type CaretEq = P<(FJointPunct<'^'>, FPunct<'='>)>;
pub type AndEq = P<(FJointPunct<'&'>, FPunct<'='>)>;
pub type OrEq = P<(FJointPunct<'|'>, FPunct<'='>)>;
pub type ShlEq = P<(FJointPunct<'<'>, FJointPunct<'<'>, FPunct<'='>)>;
pub type ShrEq = P<(FJointPunct<'>'>, FJointPunct<'>'>, FPunct<'='>)>;
pub type Eq = FPunct<'='>;
pub type EqEq = P<(FJointPunct<'='>, FPunct<'='>)>;
pub type Ne = P<(FJointPunct<'!'>, FPunct<'='>)>;
pub type Gt = FPunct<'>'>;
pub type Lt = FPunct<'<'>;
pub type Ge = P<(FJointPunct<'>'>, FPunct<'='>)>;
pub type Le = P<(FJointPunct<'<'>, FPunct<'='>)>;
pub type At = FPunct<'@'>;
pub type Dot = FPunct<'.'>;
pub type DotDot = P<(FJointPunct<'.'>, FPunct<'.'>)>;
pub type DotDotDot = P<(FJointPunct<'.'>, FJointPunct<'.'>, FPunct<'.'>)>;
pub type DotDotEq = P<(FJointPunct<'.'>, FJointPunct<'.'>, FPunct<'='>)>;
pub type Comma = FPunct<','>;
pub type Semi = FPunct<';'>;
pub type Colon = FPunct<':'>;
pub type PathSep = P<(FJointPunct<':'>, FPunct<':'>)>;
pub type RArrow = P<(FJointPunct<'-'>, FPunct<'>'>)>;
pub type FatArrow = P<(FJointPunct<'='>, FPunct<'>'>)>;
...
mod tests {
    use crate::*;
    insta_match_test!(peek parse print : it_matches_lifetime, LifetimeToken : 'hi);
}
