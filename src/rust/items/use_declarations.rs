...
mod tests {
    ...
    insta_match_test!(parse print : it_matches_simple_path, UseDeclaration : use hello::world; );
    insta_match_test!(parse print : it_matches_simple_path_as, UseDeclaration : use hello::world as h; );
    insta_match_test!(parse print : it_matches_star_path, UseDeclaration : use hello::*; );
    insta_match_test!(parse print : it_matches_complex_path, UseDeclaration :  use { hello::*, world::hi as Hi, nested::{ hello::world, hi }, }; );
}
